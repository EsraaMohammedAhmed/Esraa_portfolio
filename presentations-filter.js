// Presentations Filtering System
document.addEventListener("DOMContentLoaded", () => {
  // Get all filter buttons and presentation cards
  ...
  filterBtns.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      filterPresentations(filterValue)
    })
  })

  // Filter presentations function
  function filterPresentations(filter) {
    let visibleCount = 0

    // Loop through all presentation cards
  ...
  function adjustLayout() {
    // Get visible cards
    const visibleCards = document.querySelectorAll(".presentation-card:not(.hide)")
